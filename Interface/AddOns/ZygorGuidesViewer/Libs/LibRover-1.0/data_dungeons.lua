...
data.basenodes.DungeonEntrances = {
	...
	-- RAID ENTRANCE/EXITS
		...
		--Outland
			...
			-- Tempest Keep
			"Tempest Keep/1 50.06,91.93 -x- Netherstorm/0 73.56,63.71 {autotype:portal_dungeon}",
			-- Black Temple
		...
		--Legion
			...
			"Krokuun/0 73.44,33.84 -x- Invasion Point Sangua/0 24.18,50.61 <subtype:portalclick> {mode:PORTAL}",
			"Invasion Point Sangua/0 50.91,48.01 -x- Krokuun/0 73.44,33.84 <subtype:portalclick> {mode:PORTAL}",
			--Invasion Point: Val
			"Krokuun/0 38.49,60.97 -x- Invasion Point Val/0 38.78,74.46 <subtype:portalclick> {mode:PORTAL}",
			"Invasion Point Val/0 55.07,35.85 -x- Krokuun/0 38.49,60.97 <subtype:portalclick> {mode:PORTAL}",
			--Invasion Point: Naigtal
			"Mac'Aree/0 70.51,38.47 -x- Invasion Point Naigtal/0 25.20,29.85 <subtype:portalclick> {mode:PORTAL}",
			"Invasion Point Naigtal/0 71.95,57.46 -x- Mac'Aree/0 70.51,38.47 <subtype:portalclick> {mode:PORTAL}",
			--Invasion Point: Cen'gar
			"Antoran Wastes/0 60.24,42.98 -x- Invasion Point Cen'gar/0 27.39,28.40 <subtype:portalclick> {mode:PORTAL}",
			"Invasion Point Cen'gar/0 65.76,69.57 -x- Antoran Wastes/0 60.24,42.98 <subtype:portalclick> {mode:PORTAL}",
			--Invasion Point: Bonich
			"Mac'Aree/0 61.01,18.74 -x- Invasion Point Bonich/0 69.54,63.16 <subtype:portalclick> {mode:PORTAL}",
			"Invasion Point Bonich/0 45.39,48.18 -x- Mac'Aree/0 61.01,18.74 <subtype:portalclick> {mode:PORTAL}",
			--Invasion Point: Aurinor
			"Antoran Wastes/0 64.59,69.16 -x- Invasion Point Aurinor/0 81.75,39.02 <subtype:portalclick> {mode:PORTAL}",
			"Invasion Point Aurinor/0 20.45,52.72 -x- Antoran Wastes/0 64.59,69.16 <subtype:portalclick> {mode:PORTAL}",
