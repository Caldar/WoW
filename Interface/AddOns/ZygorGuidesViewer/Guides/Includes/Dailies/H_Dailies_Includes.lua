...
ZygorGuidesViewer:RegisterInclude("Argent Tourney_Valiant",[[
	...
	step
		...
		|only BloodElf
	step --ORC VALIANT RANK DAILY LOOP (BEGIN)
		talk Mokra the Skullcrusher##33361
		|tip You will only be able to accept one of these daily quests per day:
	...
	step
		Equip the Horde Lance |use Horde Lance##46070
		click Stabled Campaign Warhorse##34125
	...
	step
		Equip the Horde Lance |use Horde Lance##46070
		click Stabled Orgrimmar Wolf##33799
	...
	step
		...
		|only Orc
	step --TROLL VALIANT RANK DAILY LOOP
		talk Zul'tore##33372
		|tip You will only be able to accept one of these daily quests per day:
	...
	step
		Equip the Horde Lance |use Horde Lance##46070
		click Stabled Darkspear Raptor##33796
	...
	step
		...
		|only Troll
	step --TAUREN VALIANT RANK DAILY LOOP
		talk Runok Wildmane##33403
		|tip You will only be able to accept one of these daily quests per day:
	...
	step
		Equip the Horde Lance |use Horde Lance##46070
		click Stabled Thunder Bluff Kodo##33792
	...
	step
		...
		|only Tauren
	step --SCOURGE VALIANT RANK DAILY LOOP
		talk Deathstalker Visceri##33373
		|tip You will only be able to accept one of these daily quests per day:
	...
	step
		...
		|only Scourge
	step --BLOOD ELF VALIANT RANK DAILY LOOP
		talk Eressea Dawnsinger##33379
		|tip You will only be able to accept one of these daily quests per day:
	...
	step
		Equip the Horde Lance |use Horde Lance##46070
		click Stabled Silvermoon Hawkstrider##33791
	...
	step
		...
		collect 25 Valiant's Seal |q 13697/1 |only Orc
		...
		collect 25 Valiant's Seal |q 13719/1 |only Troll
		...
		collect 25 Valiant's Seal |q 13720/1 |only Tauren
		...
		collect 25 Valiant's Seal |q 13721/1 |only Scourge
		...
		collect 25 Valiant's Seal |q 13722/1 |only BloodElf
	...
	step
		Equip the Horde Lance |use Horde Lance##46070
		click Stabled Forsaken Warhorse##33798
...
ZygorGuidesViewer:RegisterInclude("August_Celestials",[[
	...
	step
		...
		click Wounded Niuzao Sentinel##61570+ |only if havequest(30953)
		...
		click Niuzao Food Supply##6478+ |only if havequest(30955)
		...
		click Sra'thik Weapon##6478+ |only if havequest(30954)
