...
Click Here After She Changes the Zone |confirm  |goto Blasted Lands/0 48.16,7.29
...
Continue through the cave |goto 63.0,28.3 < 10
Follow the cave to the left |goto 63.6,26.9 < 10
talk Kasim Sharim##42298
turnin Kasim Sharim##26157 |goto 62.5,26.3
accept Attune the Bloodstone##26158 |goto 62.5,26.3
step
...
step
talk Kasim Sharim##42298
turnin Attune the Bloodstone##26158 |goto 62.5,26.3
accept The First Step##26159 |goto 62.5,26.3
accept A Bloodmage's Gotta Eat Too##26172 |goto 62.5,26.3
step
click Bloodstone Teleporter##7585 |goto 63.2,25.9
...
collect Amulet of Allistarj |q 26167/1 |goto 61.6,26.8
step
...
collect Loramus' Torso |q 26161/2 |goto 40.0,37.2
step
...
collect Loramus' Head |q 26161/1 |goto 46.7,26.9
step
Leave the cave |goto 45.1,30.4 |walk
Enter the cave |goto 46.1,39.0 |walk
click Dreadmaul Cache##4192
collect Loramus' Legs |q 26161/3 |goto 47.0,39.5
step
...
accept Reclaiming the Ruins##9513 |goto Azuremyst Isle,47.1,70.3
step
...
step
talk Daedal##17215
turnin An Alternative Alternative##9473 |goto Azuremyst Isle,48.4,51.5
|only Draenei
step
...
step
talk Nurguni##16768
turnin On the Wings of a Hippogryph##9604 |goto The Exodar,57.0,50.1
accept Hippogryph Master Stephanos##9605 |goto The Exodar,57.0,50.1
|only Draenei
step
...
turnin Totem of Tikti##9540 |goto 64.5,39.8
accept Totem of Yor##9541 |goto 64.5,39.8
step
...
turnin Totem of Yor##9541 |goto 63,67.9
accept Totem of Vark##9542 |goto 63,67.9
step
...
turnin Totem of Vark##9542 |goto 28.1,62.4
accept The Prophecy of Akida##9544 |goto 28.1,62.4
step
...
step
talk Cowlen##17311
turnin All That Remains##9527 |goto 16.6,94.5
step
talk Arugoo the Stillpine##17114
turnin The Prophecy of Akida##9544 |goto 49.41,51.0
accept Stillpine Hold##9559 |goto 49.41,51.0
step
talk Priestess Kyleen Il'dinare##17241
turnin Warlord Sriss'tiz##9515 |goto 47,70.2
step
talk Moordo##17442
accept Beasts of the Apocalypse!##9560 |goto 44.8,23.9
step
talk Gurf##17441
accept Murlocs... Why Here? Why Now?##9562 |goto 44.7,23.6
step
talk High Chief Stillpine##17440
turnin Stillpine Hold##9559 |goto 46.7,20.6
step
...
accept Gurf's Dignity##9564 |goto 33.8,25.7
step
talk Gurf##17441
turnin Murlocs... Why Here? Why Now?##9562 |goto 44.7,23.6
turnin Gurf's Dignity##9564 |goto 44.7,23.6
step
talk Moordo##17442
turnin Beasts of the Apocalypse!##9560 |goto 44.8,23.9
step
talk High Chief Stillpine##17440
accept Search Stillpine Hold##9565 |goto 46.7,20.6
step
talk Stillpine the Younger##17445
accept Chieftain Oomooroo##9573 |goto 46.9,21.2
step
...
turnin Search Stillpine Hold##9565 |goto Azuremyst Isle/3,64.3,30.7
accept Blood Crystals##9566 |goto Azuremyst Isle/3,64.3,30.7
step
...
step
talk Kurz the Revelator##17443
turnin The Kurken is Lurkin'##9570 |goto Azuremyst Isle,47.0,22.3
accept The Kurken's Hide##9571 |goto Azuremyst Isle,47.0,22.3
step
talk High Chief Stillpine##17440
accept Warn Your People##9622 |goto 46.7,20.6
step
talk Moordo##17442
turnin The Kurken's Hide##9571 |goto 44.8,23.9
step
talk Exarch Menelaous##17116
...
turnin Coming of Age##9623 |goto 35.1,43.4
step
...
accept WANTED: Deathclaw##9646 |goto Bloodmyst Isle,55.2,59.1
step
talk Caregiver Topher Loaal##17553
home Blood Watch |goto 55.9,59.8 |future |q 9629 |goto 55.9,59.8
step
talk Morae##17434
...
turnin Cruelfin's Necklace##9576 |goto 53.3,57.8
step
...
collect 8 Elder Brown Bear Flank |q 9580/1 |goto Bloodmyst Isle,37.5,44.5
...
accept Newfound Allies##9632 |goto 54.7,54.0
step
talk Vindicator Boros##17684
...
accept Urgent Delivery##9671 |instant |goto 54.6,58.0
step
...
turnin Audience with the Prophet##9698 |goto The Exodar,32.9,54.4
accept Truth or Fiction##9699 |goto The Exodar,32.9,54.4
step
talk Vindicator Boros##17684
turnin Truth or Fiction##9699 |goto Bloodmyst Isle,55.4,55.3
accept I Shoot Magic Into the Darkness##9700 |goto Bloodmyst Isle,55.4,55.3
step
...
stickystart "Blackslitwarrior"
step
kill Blacksilt Seer##17330+
collect 3 Crude Murloc Idol |q 9549/1 |goto 38.7,21.2
step
label "Blackslitwarrior"
...
stickystart "Corruptedcrystal"
step
kill 5 Axxarien Shadowstalker##17340+ |q 9569/3 |goto 38.2,37.4
kill 5 Axxarien Hellcaller##17342+ |q 9569/2 |goto 38.2,37.4
step
label "Corruptedcrystal"
click Corrupted Crystal##6836+
collect 5 Corrupted Crystal |q 9569/4 |goto 38.2,37.4
step
...
step
talk Vindicator Boros##17684
turnin I Shoot Magic Into the Darkness##9700 |goto 55.4,55.3
step
talk Tracker Lyceon##17642
...
collect 8 Dragon Bone |q 9687/1 |goto 59.9,35.7
...
step
talk Achelus##17676
accept The Missing Expedition##9669 |goto 53.2,57.0
step
talk Vindicator Kuros##17843
accept The Cryo-Core##9703 |goto 55.6,55.2
step
talk Vindicator Aesom##17844
accept What We Know...##9753 |goto 55.5,55.4
step
talk Exarch Admetius##17658
...
Recover the Sunhawk Information |q 9756/1 |goto 54.4,54.3
step
talk Exarch Admetius##17658
...
collect 12 Medical Supplies |q 9703/1 |goto 39.6,58.9
step
talk Vindicator Kuros##17843
turnin The Cryo-Core##9703 |goto 55.6,55.2
turnin Galaen's Journal - The Fate of Vindicator Saruan##9706 |goto 55.6,55.2
accept Matis the Cruel##9711 |goto 55.6,55.2
step
talk Vindicator Aesom##17844
accept Don't Drink the Water##9748 |goto 55.5,55.4
step
...
step
talk Vindicator Aesom##17844
turnin Don't Drink the Water##9748 |goto 55.5,55.4
accept Limits of Physical Exhaustion##9746 |goto 55.5,55.4
step
talk Vindicator Kuros##17843
turnin Matis the Cruel##9711 |goto 55.6,55.2
step
talk Morae##17434
...
turnin Vindicator's Rest##9760 |goto 30.8,46.9
accept Clearing the Way##9761 |goto 30.8,46.9
...
step
kill 8 Sunhawk Saboteur##17609+ |q 9761/1 |goto 19.5,53.9
kill 8 Sunhawk Agent##17610+ |q 9761/2 |goto 19.5,53.9
step
kill 10 Sunhawk Pyromancer##17608+ |q 9746/1 |goto 25.4,56.9
...
step
talk Vindicator Corin##17986
turnin Clearing the Way##9761 |goto 30.8,46.9
...
step "Zarakh"
Follow the path up
kill Zarakh##17683 |q 9669/3 |goto 22.9,37.5
step "Creature"
kill Webbed Creature##17680+
Free 5 Expedition Researchers |q 9670/1 |goto 18.2,37.5
step "Myst"
kill 8 Myst Leecher##17523+ |q 9669/1 |goto 18.2,37.5
kill 8 Myst Spinner##17522+ |q 9669/2 |goto 18.2,37.5
step
talk Researcher Cornelius##17686
...
step
talk Vindicator Aesom##17844
turnin Limits of Physical Exhaustion##9746 |goto 55.5,55.4
accept The Sun Gate##9740 |goto 55.5,55.4
step
click Sunhawk Portal Controller##5811+
Destroy 4 Sunhawk Portal Controllers
Swim into the lake to [Bloodmyst Isle,18.9,63.5]
click Sun Gate##6927
Destroy the Sun Gate |q 9740/1 |goto 19.5,62.5
step
talk Vindicator Aesom##17844
turnin The Sun Gate##9740 |goto 55.5,55.4
step
...
Transform into a panther |havebuff 132115 |q 13892 |goto 42.4,82.3 |only if not Druid
Transform into a panther |tip Make sure you're using the panther disguise, and not your Cat Form! |goto 42.4,82.3 |only if Druid
|confirm |q 13892 |only if Druid
step
...
Use your Panther Figurine in this spot |use Panther Figurine##46696
|tip If you have a pet, dismiss it.
Transform into a panther |havebuff 132115 |q 13948 |goto 39.2,85.1 |only if not Druid
Transform into a panther |tip Make sure you're using the panther disguise, and not your Cat Form! |goto 39.2,85.1 |only if Druid
|confirm |q 13948 |only if Druid
step
