...
L["SHOPPINGCLEARDESC"] = "Очистить лист покупок"
...
L["VENDORAUTOBUYDESC"] = "Если у вас в очереди есть рецепт/вещи, то во время разговора с торговцем, который продаёт что-нибудь нужное для вашего рецепта, оно будет куплено автоматически."
