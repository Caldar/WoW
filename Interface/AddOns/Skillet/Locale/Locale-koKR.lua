...
L["Draenor Engineering"] = "드레노어 기계공학" -- Needs review
L["Enabled"] = "가능"
L["Enchant"] = "마법부여"
...
L["Ignored Materials List"] = "무시할 재료 목록" -- Needs review
...
L["VENDORAUTOBUYDESC"] = "재료가 부족할 경우 상인을 만나면 자동으로 필요한 만큼의 재료를 구매합니다." -- Needs review
